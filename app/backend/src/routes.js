 ...
 */
router.post("/get-user", authMiddleware_1.authenticateToken, UserController_1.getUserById);
/**
 * @swagger
 * /get-user:
 *   get:
 ...
 */
router.get("/get-user", authMiddleware_1.authenticateToken, UserController_1.getMe);
/**
 * @swagger
 * /new-user:
 *   post:
 ...
 */
router.post("/new-user", UserController_1.createUser);
/**
 * @swagger
 * /update-user:
 *   put:
 ...
 */
router.put("/update-user", authMiddleware_1.authenticateToken, UserController_1.updateUser);
/**
 * @swagger
 * /delete-user:
 *   delete:
 ...
 */
router.delete("/delete-user", authMiddleware_1.authenticateToken, UserController_1.destroyUser);
/**
 * @swagger
 * /patch-user:
 *   patch:
 ...
 *         description: "Erro ao atualizar usuário."
 */
router.patch("/patch-user", authMiddleware_1.authenticateToken, UserController_1.patchUser);
// VEHICLE
/**
 * @swagger
 * /create-vehicle:
 ...
 */
router.post('/create-vehicle', VehicleController_1.createVehicle);
/**
 * @swagger
 * /get-vehicles:
 *   post:
 ...
 */
router.post('/get-vehicles', VehicleController_1.getByFilters);
/**
 * @swagger
 * /get-vehicle:
 *   get:
 ...
 */
router.get('/get-vehicle', VehicleController_1.getByFipeCode);
/**
 * @swagger
 * /update-vehicle:
 *   put:
